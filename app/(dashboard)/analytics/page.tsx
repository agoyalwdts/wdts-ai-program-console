      ...
      <div className="flex-1 overflow-auto px-6 py-6 space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              ...
              Team Admin, OpenAI org costs, or Codex Enterprise Analytics jobs. OpenAI integration
              mode: <span className="font-mono">{openAiMode}</span>; Codex Enterprise Analytics mode:{" "}
        ...
        <div>
          ...
          <p className="text-xs text-slate-500 mb-3 max-w-3xl">
            ...
            ). Expand <span className="font-medium">View raw JSON</span> on a card for the exact
            vendor payload.
          </p>
